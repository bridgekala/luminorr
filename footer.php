                                    ...
                                    <div class="wptb-heading">
                                        <div class="wptb-item--inner">
                                            <h6 class="wptb-item--subtitle">
                                                ...
                                                For Any Car Paint Protection Inquiries,
                                            </h6>
                                            <h1 class="wptb-item--title">Call Luminorr Today</h1>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="wptb-image-single wow fadeInUp d-none d-lg-block">
                                            <div class="wptb-item--inner">
                                                <div class="wptb-item--image">
                                                    <img src="assets/custom/men webp.webp" alt="img" style="height:257px;">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="wptb-icon-box1 live-chat">
                                            <div class="wptb-item--inner flex-start">
                                                ...
                                                <div class="wptb-item--holder">
                                                    ...
                                                    <h5 class="wptb-item--title"> <a href="tel:+918448280511">+91 84482 80511</a></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 mb-5 mb-xl-0">
                                <div class="logo mr-bottom-30">
                                    <a href="https://www.luminorr.com/" class=""><img src="assets/custom/luminorr-logo.png" alt="logo" style="height: 42px;width:201px;"></a>
                                </div>
                                <div class="wptb-icon-box1 footer-contact-style address mr-bottom-30">
                                    <div class="wptb-item--inner flex-start">
                                        <div class="wptb-item--holder">
                                            <p class="" style="line-height:1.25rem;font-weight:500;">At Luminorr, we believe that luxury car owners deserve nothing but the best when it comes to protecting their valuable investments. With a deep passion for automotive excellence, we set out to develop the most advanced Paint Protection Film (PPF) solutions in the industry.</p>
                                            <div class="social-box">
                                                <ul>
                                                    <li><a href="https://www.facebook.com/luminordetailing/" class="bi bi-facebook"></a></li>
                                                    <li><a href="https://www.instagram.com/luminorrofficial/" class="bi bi-instagram"></a></li>
                                                </ul>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 mb-5 mb-md-0">
                                        <div class="footer-widget footer-links">
                                            ...
                                            <div class="footer-nav">
                                                <ul>
                                                    <li class="menu-item"><a href="https://www.luminorr.com/">Home</a></li>
                                                    <li class="menu-item"><a href="about-us.php">About</a></li>
                                                    <li class="menu-item"><a href="become-a-dealer.php">Become A Dealer</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="footer-widget footer-links">
                                            ...
                                            <div class="footer-nav">
                                                <ul>
                                                    ...
                                                    <li class="menu-item"><a href="product-overview.php">Product Overview</a></li>
                                    ...
                                    <div class="col-md-4 col-sm-6 mb-5 mb-md-0">
                                        <div class="footer-widget footer-links">
                                            ...
                                            <div class="wptb-icon-box1 footer-contact-style address mr-bottom-10">
                                                <div class="wptb-item--inner flex-start">
                                                    <div class="wptb-item--holder">
                                                        <h5 class="wptb-item--title"><span class="icon bi bi-geo-alt-fill" style="color:var(--color-one);"></span> A1-32, near Phawa property, Sector 15, Pocket 1, Sector 15A, Rohini, Delhi, 110085</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="wptb-icon-box1 footer-contact-style address mr-bottom-10">
                                                <div class="wptb-item--inner flex-start">
                                                    <div class="wptb-item--holder">
                                                        <h6 class=""><span class="icon bi bi-telephone" style="color:var(--color-one);"></span> +91 84482 80511</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="wptb-icon-box1 footer-contact-style address mr-bottom-10">
                                                <div class="wptb-item--inner flex-start">
                                                    <div class="wptb-item--holder">
                                                        <h6 class=""><span class="icon bi bi-envelope-fill" style="color:var(--color-one);"></span> luminorrofficial@gmail.com</h6>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="footer-bottom-inner">
                        <div class="copyright">
                            <p>&copy; Copyright 2024 <a href="https://www.luminorr.com/">Luminorr</a> Designed & Developed By <a href="https://www.bridgekala.com/">Bridgekala</a> </p>
                        </div>
                        <div class="footer-nav-bottom d-none d-xl-block">
                            <ul>
